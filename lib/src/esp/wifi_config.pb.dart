...
import 'wifi_constants.pb.dart' as $4;

import 'constants.pbenum.dart' as $0;
import 'wifi_constants.pbenum.dart' as $4;
...
class RespGetStatus extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'RespGetStatus', createEmptyInstance: create)
    ...
    ..e<$4.WifiStationState>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'staState', $pb.PbFieldType.OE, defaultOrMaker: $4.WifiStationState.Connected, valueOf: $4.WifiStationState.valueOf, enumValues: $4.WifiStationState.values)
    ..e<$4.WifiConnectFailedReason>(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'failReason', $pb.PbFieldType.OE, defaultOrMaker: $4.WifiConnectFailedReason.AuthError, valueOf: $4.WifiConnectFailedReason.valueOf, enumValues: $4.WifiConnectFailedReason.values)
    ..aOM<$4.WifiConnectedState>(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'connected', subBuilder: $4.WifiConnectedState.create)
    ..hasRequiredFields = false
  ;
  ...
  factory RespGetStatus({
    $0.Status? status,
    $4.WifiStationState? staState,
    $4.WifiConnectFailedReason? failReason,
    $4.WifiConnectedState? connected,
  }) {
  ...
  @$pb.TagNumber(2)
  $4.WifiStationState get staState => $_getN(1);
  @$pb.TagNumber(2)
  set staState($4.WifiStationState v) { setField(2, v); }
  @$pb.TagNumber(2)
  ...
  @$pb.TagNumber(10)
  $4.WifiConnectFailedReason get failReason => $_getN(2);
  @$pb.TagNumber(10)
  set failReason($4.WifiConnectFailedReason v) { setField(10, v); }
  @$pb.TagNumber(10)
  ...
  @$pb.TagNumber(11)
  $4.WifiConnectedState get connected => $_getN(3);
  @$pb.TagNumber(11)
  set connected($4.WifiConnectedState v) { setField(11, v); }
  @$pb.TagNumber(11)
  $core.bool hasConnected() => $_has(3);
  @$pb.TagNumber(11)
  void clearConnected() => clearField(11);
  @$pb.TagNumber(11)
  $4.WifiConnectedState ensureConnected() => $_ensure(3);
}
