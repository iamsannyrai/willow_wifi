...
class WiFiScanResult extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'WiFiScanResult', createEmptyInstance: create)
    ...
    ..e<$4.WifiAuthMode>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'auth', $pb.PbFieldType.OE, defaultOrMaker: $4.WifiAuthMode.Open, valueOf: $4.WifiAuthMode.valueOf, enumValues: $4.WifiAuthMode.values)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(5)
  $4.WifiAuthMode get auth => $_getN(4);
  @$pb.TagNumber(5)
  set auth($4.WifiAuthMode v) { setField(5, v); }
  @$pb.TagNumber(5)
