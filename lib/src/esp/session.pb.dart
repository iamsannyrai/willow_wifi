...
class SessionData extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SessionData', createEmptyInstance: create)
    ...
    ..aOM<$3.Sec2Payload>(12, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'sec2', subBuilder: $3.Sec2Payload.create)
  ...
  @$pb.TagNumber(12)
  $3.Sec2Payload get sec2 => $_getN(3);
  @$pb.TagNumber(12)
  set sec2($3.Sec2Payload v) { setField(12, v); }
  @$pb.TagNumber(12)
  $core.bool hasSec2() => $_has(3);
  @$pb.TagNumber(12)
  void clearSec2() => clearField(12);
  @$pb.TagNumber(12)
  $3.Sec2Payload ensureSec2() => $_ensure(3);
}
