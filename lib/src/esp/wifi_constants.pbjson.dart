...
const WifiAuthMode$json = const {
  ...
  '2': const [
    ...
    const {'1': 'WPA3_PSK', '2': 6},
    const {'1': 'WPA2_WPA3_PSK', '2': 7},
  ],
};

/// Descriptor for `WifiAuthMode`. Decode as a `google.protobuf.EnumDescriptorProto`.
final $typed_data.Uint8List wifiAuthModeDescriptor = $convert.base64Decode('CgxXaWZpQXV0aE1vZGUSCAoET3BlbhAAEgcKA1dFUBABEgsKB1dQQV9QU0sQAhIMCghXUEEyX1BTSxADEhAKDFdQQV9XUEEyX1BTSxAEEhMKD1dQQTJfRU5URVJQUklTRRAFEgwKCFdQQTNfUFNLEAYSEQoNV1BBMl9XUEEzX1BTSxAH');
